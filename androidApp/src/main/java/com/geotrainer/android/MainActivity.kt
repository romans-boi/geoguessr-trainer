                ...
                Surface(
                    ...
                    Column(modifier = Modifier.padding(16.dp)) {
                        when (val newState = state) {
                            AllQuizzesViewModel.State.Loading -> Text(text = "Loading")

                            AllQuizzesViewModel.State.Error -> Text(text = "Error")

                            is AllQuizzesViewModel.State.Data -> newState.quizSections.map { section ->
